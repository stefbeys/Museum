...
export default class CustomScrollItem extends React.Component {
  ...
  render() {
    return (
      <Animated.View style={this.props.selectedindex==this.props.index?{ borderWidth: 2, borderColor: "#fff", borderRadius: 12, zIndex: 10}:{marginLeft: this.replaceAnim, opacity: this.opacityanim}}>    
        {this.props.children}    
      </Animated.View>
    );
  }
